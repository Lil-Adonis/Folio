...
const NavBar = () => {
    return ( 
        <>
            <nav className='w-[80%] md:w-[500px] h-[80px] bg-primary-color rounded-[35px] flex justify-end items-center fixed top-[10%] left-[50%] translate-x-[-50%] translate-y-[-50%] z-[100] nav-bar bg-red-500'>
